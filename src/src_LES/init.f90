    ...
    DO j = 1,nyp
       DO i = 1,nxp
          DO k = 1,nzp
             ...
             !a_gaerop(k,i,j,2) = 0.0409*ppb*mno*1.e3*1.e-9*avog/dn0(k) !0./dn0(k)    !NO3
             !a_gaerop(k,i,j,3) = 0.0409*(ppb/rat)*mnh*1.e3*1.e-9*avog/dn0(k) !0./dn0(k)    !NH4
             a_gaerop(k,i,j,2) = ppb*1.e-9*ps(1)*avog/(rg*(273.15+a_tp(k,i,j))*dn0(k))
             a_gaerop(k,i,j,3) = ppb*1.e-9*ps(1)*avog/(rg*(273.15+a_tp(k,i,j))*dn0(k))
