    ...
    SELECT CASE (trim(short_name))
      ...
      case('Ni')
       ...
       CASE('P_cH2Os')
          ...
          IF (itype == 2) ncinfo = 'tttt'
       CASE('P_ra')
          IF (itype==0) ncinfo = 'Level 4 aerosol water mixing ratio'
          IF (itype==1) ncinfo = 'kg/kg'
          IF (itype==2) ncinfo = 'tttt'
       CASE('P_rl')
       ...
       CASE('P_rv')
          ...
          IF (itype == 2) ncinfo = 'tttt'
       CASE('P_gpNO3')
          IF (itype==0) ncinfo = 'Level 4 gas-phase concentration of NO3'
          IF (itype==1) ncinfo = 'Mols/kg'
          IF (itype==2) ncinfo = 'tttt'
       CASE('P_gpNH3')
          IF (itype==0) ncinfo = 'Level 4 gas-phase concentration of NH3'
          IF (itype==1) ncinfo = 'Mols/kg'
          IF (itype==2) ncinfo = 'tttt'
       CASE('P_RH')
