...
CONTAINS
   ...
   SUBROUTINE distr_update(kproma, kbdim, klev, level )
      ...
      zndry = 1!spec%getNSpec(type="dry")
         ...
         DO ii = 1, kbdim
            ...
            DO WHILE (.NOT. within_bins)
               ...
               DO kk = ncld, ica%cur, -1
                  ...
                  IF ( cloud(ii,jj,kk)%numc > nlim .AND. sum(cloud(ii,jj,kk)%volc(1:zndry)) > 1.e-23 ) THEN
            ...
            DO WHILE (.NOT. within_bins)
               ...
               DO kk = nice, iia%cur, -1
                  ...
                  IF ( ice(ii,jj,kk)%numc > prlim .AND. sum(ice(ii,jj,kk)%volc(1:zndry)) > 1.e-23 ) THEN
